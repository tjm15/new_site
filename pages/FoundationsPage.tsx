    ...
    >
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-20 pt-14">
        ...
        <section className="max-w-4xl space-y-4">
          <p className="text-xs font-semibold tracking-[0.2em] text-[#329c85] uppercase">About</p>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <Link
              to="/architecture"
              className="text-sm font-semibold text-[#329c85] underline-offset-2 hover:underline"
            >
        ...
        <section className="mt-14 space-y-4">
          <h2 className="text-2xl font-semibold text-[#1b1f23]">What it is — and what it isn’t</h2>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <p className="text-sm font-semibold uppercase tracking-wide text-[#329c85]">What it is</p>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <p className="text-sm font-semibold uppercase tracking-wide text-[#b91c1c]">What it isn’t</p>
              <ul className="mt-3 space-y-2 text-[#4b5563]">
                {[
        ...
        <section className="mt-14 space-y-3 max-w-3xl">
          <h2 className="text-2xl font-semibold text-[#1b1f23]">Why planning needs a shared reasoning environment</h2>
        ...
        <section className="mt-14 space-y-3 max-w-3xl">
          <h2 className="text-2xl font-semibold text-[#1b1f23]">How the Assistant changes this</h2>
          <p className="text-base leading-relaxed text-[#4b5563]">
          ...
          <ul className="ml-2 space-y-1 text-[#4b5563]">
            <li className="flex gap-2">
              <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#329c85]" />
              <span className="text-sm"><strong className="text-[#1b1f23]">spatial strategy</strong> (how places evolve),</span>
            </li>
            <li className="flex gap-2">
              <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#329c85]" />
              <span className="text-sm"><strong className="text-[#1b1f23]">casework reasoning</strong> (how proposals are assessed),</span>
            </li>
            <li className="flex gap-2">
              <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#329c85]" />
              <span className="text-sm"><strong className="text-[#1b1f23]">and monitoring</strong> (how delivery is understood).</span>
            </li>
          </ul>
          <p className="text-base leading-relaxed text-[#4b5563]">
          ...
          <div className="mt-4 inline-flex flex-wrap items-center gap-2 rounded-full bg-white px-3 py-1 text-[0.75rem] font-semibold text-[#2a3a60] ring-1 ring-slate-200">
        ...
        <section className="mt-14 space-y-4">
          <h2 className="text-2xl font-semibold text-[#1b1f23]">Design philosophy</h2>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              ...
              <div key={pillar.title} className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                <h3 className="text-lg font-semibold text-[#1b1f23]">{pillar.title}</h3>
                <p className="mt-2 text-sm leading-relaxed text-[#4b5563]">{pillar.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-14 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          <p className="text-base leading-relaxed text-[#4b5563]">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            <Link to="/research" className="text-sm font-semibold text-[#329c85] underline-offset-2 hover:underline">
